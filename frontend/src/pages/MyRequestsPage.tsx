...
export function MyRequestsPage() {
  ...
  const [result, setResult] =
    useState<PageResponse<FundRequest> | null>(null);
    ...
    <main className="page-content">
      <section className="page-heading">
        <div>
          ...
          <p>
            Lihat dan kelola seluruh pengajuan dana
            yang kamu buat.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="pagination">
              <span>
                Menampilkan {result.content.length} dari{" "}
                {result.totalElements} pengajuan
              </span>
          ...
          <div className="empty-state">
            ...
            <p>
              Pengajuan yang kamu buat akan tampil
              di halaman ini.
            </p>
