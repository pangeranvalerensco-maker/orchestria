...
public class OrganizationClient {
        ...
        public OrganizationClient(
                        @Value("${services.organization.base-url:http://localhost:8002}") String organizationBaseUrl) {
        ...
        public OrganizationMemberContextResponse getCurrentMemberContext(
                ...
                try {
                        ApiResponse<OrganizationMemberContextResponse> response = restClient.get()
                                        ...
                                        .retrieve()
                                        .body(
                                                        new ParameterizedTypeReference<ApiResponse<OrganizationMemberContextResponse>>() {
                                                        });
